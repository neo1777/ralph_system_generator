# Ralph System Instructions: Test_ralph_test_llm
...
### LLM CLI (simonw/llm) - Recommended
1. Install LLM by Simon Willison:
   `pip install llm` or `brew install llm`
   
   
   (No plugin needed for OpenAI)

### API Keys Configuration
Run the following to set up keys:
