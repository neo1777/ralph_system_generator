#!/bin/bash
# Ralph Loop Orchestrator for Test_ralph_test_claude
# Optimized for: Claude 3.5 Sonnet
# CLI Tool: Claude CLI (Anthropic)
...
echo "Starting Ralph Loop for Test_ralph_test_claude..."
...
EOF
  ...
  OUTPUT=$(cat input_prompt.txt | claude --print)
  echo "$OUTPUT"
