...
const uiDict: Record<AppLanguage, Record<string, string>> = {
  [AppLanguage.EN]: {
    ...
    model: "AI Model",
    modelHelp: "Reasoning models (o3/DeepSeek V3.2) are slower but write better code.",
    ...
    tool_gemini: "Google Gemini CLI v0.23+",
    tool_claude: "Anthropic Claude Code CLI",
    tool_openai: "OpenAI Codex CLI v0.87+",
    tool_ollama: "Ollama (Local / DeepSeek R1)",
    tool_curl: "cURL (Universal OpenAI-Compatible Adaptor)",
    ...
    group_cohere: "Cohere",
    group_groq: "Groq (Llama 3 / DeepSeek R1)",
    lbl_code: "Code",
  ...
  [AppLanguage.IT]: {
    ...
    model: "Modello AI",
    modelHelp: "I modelli Reasoning (o3/DeepSeek V3.2) sono più lenti ma scrivono codice migliore.",
    ...
    tool_claude: "Anthropic Claude Code CLI",
    tool_openai: "OpenAI Codex CLI v0.87+",
    tool_ollama: "Ollama (Locale / DeepSeek R1)",
    tool_curl: "cURL (Adattatore Universale OpenAI)",
    group_google: "Google Gemini",
    group_anthropic: "Anthropic Claude",
    group_openai: "OpenAI",
    group_deepseek: "DeepSeek / Open Source",
    ...
    instr_setup_gemini_step1: "Installa Gemini CLI: npm install -g @google/gemini-cli",
    instr_setup_gemini_step2: "Esegui 'gemini' per autenticarti",
    instr_setup_ollama: "Installa Ollama e scarica il tuo modello",
    instr_setup_claude: "npm install -g @anthropic-ai/claude-code",
    instr_setup_openai_step1: "Installa OpenAI Python: pip install openai",
    instr_setup_openai_step2: "Installa anche 'jq' per il parsing JSON",
    instr_setup_curl: "Assicurati che 'curl' e 'jq' siano installati (Standard nella maggior parte degli ambienti)",
    ...
    instr_keys_gemini: "Autenticazione gestita dal comando 'gemini'",
